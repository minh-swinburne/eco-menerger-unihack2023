...
const char* ssid = "UniHack 2023";          //Tên mạng Wifi mà Socket server của bạn đang kết nối
const char* password = "Tech4Env";  //Pass mạng wifi ahihi, anh em rãnh thì share pass cho mình với.
 
char host[] = "172.16.255.214";  //Địa chỉ IP dịch vụ, hãy thay đổi nó theo địa chỉ IP Socket server của bạn.
int port = 3414;                  //Cổng dịch vụ socket server do chúng ta tạo!
